...
function ProjectMyTeamSchedule() {
  ...
  async function loadSchedule() {
    await axios
      .get(SERVER_URL + "/matching-service/api/v1/matchings/" + teamId + "/timetables")
      .then((res) => {
        let tmpScheduleList = [];
  ...
  async function postSchedule() {
    ...
    await axios
      .post(SERVER_URL + "/matching-service/api/v1/matchings/" + teamId + "/timeTable", data)
      .then((res) => {
        loadSchedule();
      })
      .catch((err) => {
  ...
  async function deleteSchedule(id) {
    //id에 해당하는 일정 삭제
    await axios
      .delete(SERVER_URL + "/matching-service/api/v1/matchings/" + teamId + "/" + id)
      .then((res) => {
        loadSchedule();
      })
      .catch((err) => {
